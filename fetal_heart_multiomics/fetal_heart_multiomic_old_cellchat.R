...
netVisual_bubble(cellchat, sources.use = 8, targets.use = c(2,3,4,5), remove.isolate = FALSE)

netVisual_bubble(cellchat, sources.use = 13, targets.use = 2, remove.isolate = FALSE,grid.on = FALSE,thresh = 0.05) + coord_flip()
netVisual_bubble(cellchat, sources.use = 2, targets.use = 13, remove.isolate = FALSE,grid.on = FALSE,thresh = 0.05) + coord_flip()

netVisual_bubble(cellchat, sources.use = 2, targets.use = c(3,4), remove.isolate = FALSE,grid.on = FALSE,thresh = 0.05) + coord_flip()
