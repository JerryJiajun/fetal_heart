...
Sinoid <- readRDS("~/heart_perturb_seq_analysis/Sinoid_annotated.rds")
data_input <- GetAssayData(Sinoid,layer = "data",assay = "RNA")

meta <- data.frame(labels = Idents(Sinoid),row.names = names(Idents(Sinoid)))
...
netVisual_bubble(cellchat, sources.use = 2, targets.use = 6, remove.isolate = FALSE,grid.on = FALSE,thresh = 0.01) + coord_flip()
netVisual_bubble(cellchat, sources.use = 1, targets.use = 6, remove.isolate = FALSE,grid.on = FALSE,thresh = 0.01) + coord_flip()
netVisual_bubble(cellchat, sources.use = 3, targets.use = 6, remove.isolate = FALSE,grid.on = FALSE,thresh = 0.01) + coord_flip()
netVisual_bubble(cellchat, sources.use = 4, targets.use = 6, remove.isolate = FALSE,grid.on = FALSE,thresh = 0.01) + coord_flip()
netVisual_bubble(cellchat, sources.use = 5, targets.use = 6, remove.isolate = FALSE,grid.on = FALSE,thresh = 0.01) + coord_flip()
...
saveRDS(cellchat, file = "cellchat_Sinoid.rds")
